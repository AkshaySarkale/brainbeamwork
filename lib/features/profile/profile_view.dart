        ...
        return SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _buildListTile(Icons.person_outline, 'Edit Profile', () => Get.toNamed(AppRoutes.editProfile)),
              _buildListTile(Icons.inventory_2_outlined, 'My Orders', () => Get.toNamed(AppRoutes.orders)),
              _buildListTile(Icons.location_on_outlined, 'My Addresses', () => Get.toNamed(AppRoutes.addresses)),
              _buildListTile(Icons.favorite_outline, 'Wishlist', () => Get.toNamed(AppRoutes.wishlist)),
              
              const SizedBox(height: 24),
              
              // Security Section
              _buildSectionHeader('SECURITY'),
              _buildListTile(Icons.lock_outline, 'Change Password', () => Get.toNamed(AppRoutes.changePassword)),

              const SizedBox(height: 24),

              // Logout Section
              _buildSectionHeader('ACCOUNT'),
              _buildListTile(Icons.logout, 'Logout', () => controller.logout(), isDestructive: true),
