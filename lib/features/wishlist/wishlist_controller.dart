...
class WishlistController extends GetxController {
  ...
  Future<void> fetchWishlist() async {
    try {
      ...
      AppUtils.showSnackbar('Error', 'Failed to load wishlist data.', isError: true);
    } finally {
  ...
  Future<void> addToWishlist(ProductModel product) async {
    if (Get.find<AuthController>().firebaseUser.value == null) {
      AppUtils.showSnackbar('Authentication Required', 'Please login to add products to your wishlist.', isError: true);
      return;
    }
    ...
    try {
      ...
      AppUtils.showSnackbar('Error', 'Unable to add to wishlist.', isError: true);
    } finally {
  ...
  Future<void> removeByProductId(int productId) async {
    ...
    try {
      ...
      backupIndex = wishlistItems.indexWhere((item) => item.productId == productId);
      ...
      AppUtils.showSnackbar('Error', 'Unable to remove from wishlist.', isError: true);
    } finally {
      isUpdating.value = false;
    }
  }
  ...
  Future<void> clearWishlist() async {
    ...
    try {
      ...
      AppUtils.showSnackbar('Error', 'Unable to clear wishlist.', isError: true);
    } finally {
      isUpdating.value = false;
    }
  }
