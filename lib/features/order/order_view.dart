          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const Text('No orders yet.', style: AppTextStyles.heading2),
                const SizedBox(height: 8),
                const Text('Start shopping to place your first order.', style: AppTextStyles.bodyMedium),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text('Order #$orderIdDisplay', style: AppTextStyles.heading2),
                      Text('₹${order.total.toStringAsFixed(0)}', style: AppTextStyles.heading2.copyWith(color: AppColors.primary)),
                    ],
                  ),
                  const SizedBox(height: 8),
                  Text('${order.items.length} Item(s)', style: AppTextStyles.bodyMedium),
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () => Get.toNamed(AppRoutes.orderDetails, arguments: {'order': order}),
